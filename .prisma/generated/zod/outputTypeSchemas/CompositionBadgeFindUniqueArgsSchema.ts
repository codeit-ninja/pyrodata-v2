...
export const CompositionBadgeFindUniqueArgsSchema: z.ZodType<Prisma.CompositionBadgeFindUniqueArgs> = z.object({
  select: CompositionBadgeSelectSchema.optional(),
  where: CompositionBadgeWhereUniqueInputSchema,
}).strict() ;

export default CompositionBadgeFindUniqueArgsSchema;
